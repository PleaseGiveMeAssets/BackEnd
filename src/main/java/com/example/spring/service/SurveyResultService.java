...
public interface SurveyResultService {
    ...
    // 사용자의 총 점수를 계산
    int getTotalScore(); // memberId 파라미터 제거
    ...
    InvestmentTypeAnswerDTO getInvestmentTypeByMemberId(); // memberId 파라미터 제거

    // 사용자의 투자유형 ID로 INVESTMENT_TYPE 테이블에서 상세 정보를 조회
    InvestmentTypeDTO getInvestmentTypeDetails(); // memberId 파라미터 제거
