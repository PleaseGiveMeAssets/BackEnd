...
public class StockPortfolioController {
    ...
    @GetMapping
    public ResponseEntity<List<StockPortfolioDTO>> getStockPortfolioInfo(@RequestParam String userId) {
        return ResponseEntity.ok(stockPortfolioService.getStockPortfolioInfo(userId));
    }
}
